...
The source workbook intentionally does not contain calculated Sales Amount, Discount Amount, COGS, Refund Amount, Net Revenue, Return Days or Return Rate.

These are derived in Power BI rather than added to the raw source.
